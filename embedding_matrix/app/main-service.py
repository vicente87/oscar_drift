...
# The main idea of this service is to run and list the output bucket of the DRS service to see when N embedding has been done, if the N results are not there, the service does 
# nothing else. Once you have N embedding create an array (json object) with the results of the DRS service.
